...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'deactivate'], function() {
        ...
        Route::post('change-request-update/{id}','RequestController@update_request')->name('change-requests-update');
        ...
        Route::post('/acknowledge_request', 'AcknowledgementController@aknowledge');
